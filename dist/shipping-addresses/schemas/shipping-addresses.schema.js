...
exports.ShippingAddressSchema = exports.ShippingAddress = void 0;
const base_schema_1 = require("../../common/schemas/base-schema");
const mongoose_1 = require("@nestjs/mongoose");
const mongoose_2 = require("mongoose");
let ShippingAddress = class ShippingAddress extends base_schema_1.BaseSchema {
};
...
__decorate([
    (0, mongoose_1.Prop)({ type: String, default: 'Nigeria' }),
    __metadata("design:type", String)
...
], ShippingAddress.prototype, "isDefault", void 0);
...
exports.ShippingAddressSchema.index({ userId: 1 });
exports.ShippingAddressSchema.index({ userId: 1, isDefault: 1 });
//# sourceMappingURL=shipping-addresses.schema.js.map